...
public class ProductosService {
	...
	// GET PRODUCTOs by CATEGORIA activos
	...
	// GET PRODUCTOs by CATEGORIA eliminados
	public List<ProductosListDTO> buscarProductosByCategoriaEliminados( int idCategoria ){
		List<ProductosModel> productos = productosRepository.findAll();
		List<ProductosListDTO> productosListDTO = new ArrayList<>();
		
		for( ProductosModel producto : productos ) {
			if(producto.getCategoria().getIdCategoria() == idCategoria && producto.getIsHabilitadoProducto() == false) {
				ProductosListDTO prodDTO = new ProductosListDTO();
